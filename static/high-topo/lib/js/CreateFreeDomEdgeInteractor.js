var CreateFreeDomEdgeInteractor = function (graphView) {
    CreateFreeDomEdgeInteractor.superClass.constructor.call(this, graphView);
};
ht.Default.def(CreateFreeDomEdgeInteractor, ht.graph.Interactor, {
    setUp: function () {
        CreateFreeDomEdgeInteractor.superClass.setUp.call(this);
        this._autoMakeVisible = this._graphView.isAutoMakeVisible();
        this._graphView.setAutoMakeVisible(false);
    },
    tearDown: function () {
        CreateFreeDomEdgeInteractor.superClass.tearDown.call(this);
