var CreateFreeDomBrokenEdgeInteractor = function (graphView) {
    CreateFreeDomBrokenEdgeInteractor.superClass.constructor.call(this, graphView);
};
ht.Default.def(CreateFreeDomBrokenEdgeInteractor, ht.graph.Interactor, {
    setUp: function () {
        CreateFreeDomBrokenEdgeInteractor.superClass.setUp.call(this);
        this._autoMakeVisible = this._graphView.isAutoMakeVisible();
        this._graphView.setAutoMakeVisible(false);
    },
    tearDown: function () {
        CreateFreeDomBrokenEdgeInteractor.superClass.tearDown.call(this);
